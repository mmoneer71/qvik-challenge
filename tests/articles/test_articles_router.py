...
def test_create_article(app_client: TestClient, clean_state):
    ...
    assert article.json() == {"id": 1, "url": "https://edition.cnn.com/2020/09/21/us/arctic-sea-ice-shrunk-minimum-extent-2020-scn-trnd/index.html", "channel_id": 1, "word_count": 473}
...
def test_update_article_channel_name(app_client: TestClient):
    ...
    assert response.status_code == HTTPStatus.OK
    assert response.json() == {"id": 1, "url": "https://edition.cnn.com/2020/09/21/us/arctic-sea-ice-shrunk-minimum-extent-2020-scn-trnd/index.html", "channel_id": 2, "word_count": 473}
